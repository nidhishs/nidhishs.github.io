---
title: 'Adding Haptic Feedback to Your Keyboard'
date: 2025-02-19
description: 'A complete guide to adding haptic feedback to a custom mechanical keyboard using DRV2605L: component selection, PCB layout, and ZMK firmware for linear resonant actuators.'
---
...
<figure>
  <img src="/writing/20250219.adding-haptics-to-your-kb/eos.webp" alt="Eos, a 30-key split ergonomic keyboard.">
  <figcaption>The Eos Keyboard, a 30-key split ergonomic board, designed by me!</figcaption>
</figure>

This guide covers the full process of adding a haptic system to a custom keyboard. I'll walk through component selection, installation, and writing the ZMK firmware to control the linear resonant actuators (LRAs). You'll learn what it takes to add this dimension to your typing experience, whether you're building a new board or just exploring what's possible.
...
This is most useful in a few places:

- **Layer activation:** Confirm that you've switched layers before hitting the next key.
- **Home row mods:** Tell when a hold registered as a modifier instead of a tap.
- **Combos:** Confirm that the key combination actually fired.
- **Timing-sensitive keys:** Make hold-tap behavior easier to learn and adjust.
...
<figure>
  <img src="/writing/20250219.adding-haptics-to-your-kb/haptic-schematics.webp" alt="Haptic Schematics.">
...
<figure>
  <img src="/writing/20250219.adding-haptics-to-your-kb/haptic-pcb-routing.webp" alt="Haptic Kicad Routing of DRV2605L.">
...
<figure class="w-4/5">
  <img src="/writing/20250219.adding-haptics-to-your-kb/DRV2605L-Solder.webp" alt="Circuit board closeup showing DRV2605L haptic driver IC.">
...
That's the full breakdown. Adding haptic feedback to your custom keyboard is a rewarding project. By following this guide, you've learned how to select the right components, design and assemble the PCB, and configure the firmware to bring your keyboard to life with tactile feedback.

The possibilities for personalization are endless. Customize the vibration patterns to match your workflow, tune the intensity to your preference, or experiment with different actuators. Thanks for reading. Happy building, and may your keyboard be as expressive as your creativity allows!
